...
export default {
  ...
  methods:{
    ...
    proccessFillFields(){
    this.getAllBrands()
    console.log('BrandProductEditingFormInfo')
    console.log(this.$store.state.products.BrandProductEditingFromInfos)
    //prepare default values for variables
    let editingProduct = this.$store.state.products.BrandProductEditingFromInfos;
    this.newProductInfos.category=editingProduct.category_category_parent_id;
    this.newProductInfos.subCategory=editingProduct.category_category_id;
    ...
    this.$store.dispatch('products/getAllSubCategories',editingProduct.category_category_parent_id)
    }
