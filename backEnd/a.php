...
$url = "http://fishopping.ir/serverHypernetShowUnion/GetBrandsProductsWhenClickedBrandsName.php";
$post = [
     ...
     <div class="container" style="width:100%;">
          ...
          <div class="table-responsive">
               ...
               <div id="employee_table">
                    <table id='myInputTextField' class="table table-bordered">
                         <tr>
                              <th width="8%">ردیف</th>
...
<script>
     $(document).ready(function() {
          ...
          $(document).on('click', '.edit_data', function() {
               ...
               $.ajax({
                    url: "http://fishopping.ir/serverHypernetShowUnion/fetch.php",
                    method: "POST",
                    data: {
          ...
          $('#insert_form').on("submit", function(event) {
               ...
               if ($('#name').val() == "") {
                    ...
                    $.ajax({
                         url: "http://fishopping.ir/serverHypernetShowUnion/insert.php",
                         method: "POST",
     ...
     /* $(document).on('click', '.delete_data', function() {
           var product_id = $(this).attr("id");
           $.ajax({
                url: "http://fishopping.ir/serverHypernetShowUnion/delete.php",
                method: "POST",
                data: {
                     product_id: product_id
                },
     ...
     $('.delete_data').click(function() {
          ...
          var checkstr = confirm('آیا از حذف کالا اطمیناندارید؟');
