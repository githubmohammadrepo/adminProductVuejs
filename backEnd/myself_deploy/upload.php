...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="http://fishopping.ir/dist/img/icons/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="http://fishopping.ir/dist/img/icons/favicon-16x16.png">
  <link rel="manifest" href="http://fishopping.ir/dist/manifest.json">
  <meta name="theme-color" content="#4DBA87">
  <meta name="apple-mobile-web-app-capable" content="no">
  <meta name="apple-mobile-web-app-status-bar-style" content="default">
  <meta name="apple-mobile-web-app-title" content="adminproduct">
  <link rel="apple-touch-icon" href="http://fishopping.ir/dist/img/icons/apple-touch-icon-152x152.png">
  <link rel="mask-icon" href="http://fishopping.ir/dist/img/icons/safari-pinned-tab.svg" color="#4DBA87">
  <meta name="msapplication-TileImage" content="http://fishopping.ir/dist/img/icons/msapplication-icon-144x144.png">
